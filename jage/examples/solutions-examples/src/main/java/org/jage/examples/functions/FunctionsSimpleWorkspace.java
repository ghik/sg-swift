...
/*
 * Created: 2012-04-20
 * $Id: FunctionsSimpleWorkspace.java 471 2012-10-30 11:17:00Z faber $
 */
...
public class FunctionsSimpleWorkspace extends IsolatedSimpleWorkplace {
	...
	public FunctionsSimpleWorkspace(final AgentAddress address) {
		super(address);
	}

	@Inject
	public FunctionsSimpleWorkspace(final AgentAddressSupplier supplier) {
		super(supplier);
	}
