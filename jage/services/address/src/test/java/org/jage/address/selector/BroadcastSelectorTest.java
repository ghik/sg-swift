...
/*
 * Created: 2009-03-12
 * $Id: BroadcastSelectorTest.java 471 2012-10-30 11:17:00Z faber $
 */
...
public class BroadcastSelectorTest extends AbstractBroadcastSelectorTest {
	...
	private BroadcastSelector<AgentAddress> selector;

	@Before
	public void setUp() {
		selector = new BroadcastSelector<AgentAddress>();
