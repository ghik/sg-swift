...
/*
 * Created: 2011-08-29
 * $Id: MultiUnusedSelectorTest.java 471 2012-10-30 11:17:00Z faber $
 */
...
public class MultiUnusedSelectorTest extends AbstractAddressSelectorTest {
	...
	private MultiUnusedSelector<AgentAddress> selector;
	...
	public void setUp() {
		...
		selector = new MultiUnusedSelector<AgentAddress>(addressCount);
	}
