...
/*
 * Created: 2012-02-07
 * $Id: PublishSubscribeProtocolTest.java 471 2012-10-30 11:17:00Z faber $
 */
...
public class PublishSubscribeProtocolTest {
	...
	@InjectMocks
	private final PublishSubscribeProtocol pubsubProtocol = new PublishSubscribeProtocol(null);
	...
	public void testMessageListenerInteraction() {
		// given
		final DefaultNodeAddress address = new DefaultNodeAddress("test1", "hostname");
		final MessageReceivedListener listener = mock(MessageReceivedListener.class);
		final IMessage<ComponentAddress, Serializable> message = MessageTestUtils.createEmptyComponentMessage("from",
		        "to", address);
